...
class DisconnectGreenSourcePlanUnitTest {
	...
	void isPlanExecutableNoServersValidForDisconnection() {
		var mockGS1 = ImmutableGreenEnergyAgentArgs.builder()
				...
				.monitoringAgent("test_monitoring1")
				.ownerSever("test_server1")
				.connectedSevers(new ArrayList<>(List.of("test_server2", "test_server1")))
				.latitude("50")
				.longitude("30")
				.pricePerPowerUnit("10")
				.weatherPredictionError("0.02")
		...
		var mockGS2 = ImmutableGreenEnergyAgentArgs.builder()
				...
				.monitoringAgent("test_monitoring2")
				.ownerSever("test_server2")
				.connectedSevers(new ArrayList<>(List.of("test_server3", "test_server5")))
				.latitude("50")
				.longitude("30")
				.pricePerPowerUnit("10")
				.weatherPredictionError("0.02")
	...
	private void prepareNetworkStructure() {
		var mockGS1 = ImmutableGreenEnergyAgentArgs.builder()
				...
				.monitoringAgent("test_monitoring1")
				.ownerSever("test_server1")
				.connectedSevers(new ArrayList<>(List.of("test_server1", "test_server2")))
				.latitude("50")
				.longitude("30")
				.pricePerPowerUnit("10")
				.weatherPredictionError("0.02")
		...
		var mockGS2 = ImmutableGreenEnergyAgentArgs.builder()
				...
				.connectedSevers(new ArrayList<>(List.of("test_server2", "test_server3")))
				.latitude("50")
				.longitude("30")
				.pricePerPowerUnit("10")
				.weatherPredictionError("0.02")
