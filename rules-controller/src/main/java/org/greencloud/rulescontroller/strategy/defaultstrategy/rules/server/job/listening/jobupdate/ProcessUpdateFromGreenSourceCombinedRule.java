...
import org.greencloud.rulescontroller.strategy.defaultstrategy.rules.server.job.listening.jobupdate.processing.ProcessUpdateFromGreenSourceJobConfirmationRule;
import org.greencloud.rulescontroller.strategy.defaultstrategy.rules.server.job.listening.jobupdate.processing.ProcessUpdateFromGreenSourceJobFailureRule;
import org.greencloud.rulescontroller.strategy.defaultstrategy.rules.server.job.listening.jobupdate.processing.ProcessUpdateFromGreenSourceTransferConfirmationRule;
import org.greencloud.rulescontroller.strategy.defaultstrategy.rules.server.job.listening.jobupdate.processing.ProcessUpdateFromGreenSourceTransferFailureRule;
