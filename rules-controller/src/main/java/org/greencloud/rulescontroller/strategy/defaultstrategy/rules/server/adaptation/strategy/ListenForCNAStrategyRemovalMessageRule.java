...
public class ListenForCNAStrategyRemovalMessageRule extends AgentMessageListenerRule<ServerAgentProps, ServerNode> {

	public ListenForCNAStrategyRemovalMessageRule(final RulesController<ServerAgentProps, ServerNode> controller,
