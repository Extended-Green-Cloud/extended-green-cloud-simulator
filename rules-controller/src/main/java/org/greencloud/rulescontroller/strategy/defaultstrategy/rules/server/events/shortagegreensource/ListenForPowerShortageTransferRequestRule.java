...
public class ListenForPowerShortageTransferRequestRule extends AgentMessageListenerRule<ServerAgentProps, ServerNode> {
	...
	public ListenForPowerShortageTransferRequestRule(
			final RulesController<ServerAgentProps, ServerNode> controller, final Strategy strategy) {
		super(controller, strategy, JobPowerShortageTransfer.class, LISTEN_FOR_POWER_SHORTAGE_TRANSFER_REQUEST_TEMPLATE,
