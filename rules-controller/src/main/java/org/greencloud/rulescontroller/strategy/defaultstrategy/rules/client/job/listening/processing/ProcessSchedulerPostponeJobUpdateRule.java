...
public class ProcessSchedulerPostponeJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {
	...
	public void executeRule(final StrategyFacts facts) {
		...
		final Instant postponedStart = postponeTime(agentProps.getJobSimulatedStart(), AnnouncingConstants.JOB_RETRY_MINUTES_ADJUSTMENT);
		final Instant postponedEnd = postponeTime(agentProps.getJobSimulatedEnd(), AnnouncingConstants.JOB_RETRY_MINUTES_ADJUSTMENT);
