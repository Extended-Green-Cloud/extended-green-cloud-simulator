package org.greencloud.rulescontroller.strategy.defaultstrategy.rules.greenenergy.job.proposing.processing;
...
public class ProcessNotEnoughResourcesBeforePowerSupplyRule
	...
	public void executeRule(final StrategyFacts facts) {
		...
		final StrategyFacts finishJobFacts = new StrategyFacts(facts.get(STRATEGY_IDX));
