package org.greencloud.rulescontroller.strategies.defaultstrategy.rules.cloudnetwork.errorhandling.weatherdrop;
...
public class HandleCNAWeatherDropEventRule extends AgentBasicRule<CloudNetworkAgentProps, CloudNetworkNode> {
	...
	public void executeRule(final StrategyFacts facts) {
		...
		handlerFacts.put(STRATEGY_TYPE, WEATHER_DROP_STRATEGY);
