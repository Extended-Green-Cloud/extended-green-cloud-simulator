package org.greencloud.rulescontroller.strategies.defaultstrategy.rules.server.events.resupply.processing;
		...
		if (agentProps.getServerJobs().containsKey(job)) {
			...
			if (nonNull(isActive)) {
				...
				if(Boolean.TRUE.equals(isActive)) {
					agent.send(prepareJobStatusMessageForCNA(mapToJobInstanceId(job), GREEN_POWER_JOB_ID, agentProps,
