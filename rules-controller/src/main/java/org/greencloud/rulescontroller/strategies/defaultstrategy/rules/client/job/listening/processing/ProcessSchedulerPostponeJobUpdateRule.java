package org.greencloud.rulescontroller.strategies.defaultstrategy.rules.client.job.listening.processing;
...
public class ProcessSchedulerPostponeJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {
	...
	public void executeRule(final StrategyFacts facts) {
		...
		final Instant postponedStart = postponeTime(agentProps.getJobSimulatedStart(), JOB_RETRY_MINUTES_ADJUSTMENT);
		final Instant postponedEnd = postponeTime(agentProps.getJobSimulatedEnd(), JOB_RETRY_MINUTES_ADJUSTMENT);
