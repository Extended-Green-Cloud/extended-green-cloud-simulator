package org.greencloud.agentsystem.strategies.executiontimebased.regionalmanager.job.request;
...
public class RequestJobExecutionTime extends AgentRequestRule<RegionalManagerAgentProps, RMANode> {

	public RequestJobExecutionTime(final RulesController<RegionalManagerAgentProps, RMANode> controller) {
		super(controller);
	}
	...
	public AgentRule copy() {
		return new RequestJobExecutionTime(controller);
	}
