package org.greencloud.agentsystem.strategies.rulesets.base.basetwostepallocation.rules.server.initial;
...
public class StartInitialServerTwoAllocationBehaviours extends AgentBehaviourRule<ServerAgentProps, ServerNode> {

	public StartInitialServerTwoAllocationBehaviours(final RulesController<ServerAgentProps, ServerNode> controller) {
		super(controller);
	}
	...
	public AgentRule copy() {
		return new StartInitialServerTwoAllocationBehaviours(controller);
	}
