package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.centralmanager.job.announcing;
...
public class LookForRMAForJobExecutionRule extends AgentCFPRule<CentralManagerAgentProps, CMANode> {
	...
	private void handleFailure(final Facts facts) {
		final ClientJob job = facts.get(JOB);
		final RuleSetFacts failureFacts = constructFactsWithJob(facts.get(RULE_SET_IDX), job);
