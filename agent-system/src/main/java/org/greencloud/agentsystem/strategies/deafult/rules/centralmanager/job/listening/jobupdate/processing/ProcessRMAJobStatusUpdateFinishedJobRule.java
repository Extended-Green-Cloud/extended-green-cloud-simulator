package org.greencloud.agentsystem.strategies.deafult.rules.centralmanager.job.listening.jobupdate.processing;
...
public class ProcessRMAJobStatusUpdateFinishedJobRule extends AgentBasicRule<CentralManagerAgentProps, CMANode> {
	...
	public AgentRule copy() {
		return new ProcessRMAJobStatusUpdateFinishedJobRule(controller);
	}
