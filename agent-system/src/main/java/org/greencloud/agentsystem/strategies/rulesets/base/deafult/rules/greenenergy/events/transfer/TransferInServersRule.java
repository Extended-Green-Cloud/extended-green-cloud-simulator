package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.greenenergy.events.transfer;
...
public class TransferInServersRule extends AgentRequestRule<GreenEnergyAgentProps, GreenEnergyNode> {
	...
	protected void handleRefuse(final ACLMessage refuse, final RuleSetFacts facts) {
		...
		final RuleSetFacts refuseFacts = constructFactsWithJob(facts.get(RULE_SET_IDX), job);
