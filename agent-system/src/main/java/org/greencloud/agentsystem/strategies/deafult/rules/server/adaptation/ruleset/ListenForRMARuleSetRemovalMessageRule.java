package org.greencloud.agentsystem.strategies.deafult.rules.server.adaptation.ruleset;
...
public class ListenForRMARuleSetRemovalMessageRule extends AgentMessageListenerRule<ServerAgentProps, ServerNode> {
	...
	public AgentRule copy() {
		return new ListenForRMARuleSetRemovalMessageRule(controller, getRuleSet());
	}
