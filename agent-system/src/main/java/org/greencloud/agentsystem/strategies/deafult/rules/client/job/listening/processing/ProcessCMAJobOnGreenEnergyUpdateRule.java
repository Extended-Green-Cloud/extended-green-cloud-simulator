...
public class ProcessCMAJobOnGreenEnergyUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAJobOnGreenEnergyUpdateRule.class);

	public ProcessCMAJobOnGreenEnergyUpdateRule(
	...
	public void executeRule(final RuleSetFacts facts) {
		...
		logger.info("My job is being executed using the green power!");
	...
	public AgentRule copy() {
		return new ProcessCMAJobOnGreenEnergyUpdateRule(controller);
	}
