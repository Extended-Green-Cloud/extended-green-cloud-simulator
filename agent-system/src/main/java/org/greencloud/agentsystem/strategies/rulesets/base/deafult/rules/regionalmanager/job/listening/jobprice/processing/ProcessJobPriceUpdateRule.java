package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.regionalmanager.job.listening.jobprice.processing;
...
public class ProcessJobPriceUpdateRule extends AgentBasicRule<RegionalManagerAgentProps, RMANode> {

	private static final Logger logger = getLogger(ProcessJobPriceUpdateRule.class);

	public ProcessJobPriceUpdateRule(final RulesController<RegionalManagerAgentProps, RMANode> controller) {
		super(controller);
	}
	...
	public AgentRule copy() {
		return new ProcessJobPriceUpdateRule(controller);
	}
