...
public class ProcessNewJobServerVerificationNoResourcesRule extends AgentBasicRule<RegionalManagerAgentProps, RMANode> {

	private static final Logger logger = getLogger(ProcessNewJobServerVerificationNoResourcesRule.class);

	public ProcessNewJobServerVerificationNoResourcesRule(
	...
	public AgentRuleDescription initializeRuleDescription() {
		return new AgentRuleDescription(NEW_JOB_VERIFICATION_RULE, NEW_JOB_RECEIVER_HANDLE_NO_RESOURCES_RULE,
				"handles new job verification - the assigned server does not have required resources",
	...
	public void executeRule(final RuleSetFacts facts) {
		...
		logger.info("The selected server does not have required resources!");
	...
	public AgentRule copy() {
		return new ProcessNewJobServerVerificationNoResourcesRule(controller);
	}
