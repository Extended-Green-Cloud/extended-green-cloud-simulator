...
import static org.greencloud.commons.enums.rules.EGCSDefaultRuleType.JOB_STATUS_RECEIVER_HANDLE_POSTPONED_RULE;
...
import org.greencloud.agentsystem.strategies.deault.rules.scheduler.job.announcing.domain.AnnouncingConstants;
...
public class ProcessSchedulerPostponeJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {
	...
	public ProcessSchedulerPostponeJobUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
