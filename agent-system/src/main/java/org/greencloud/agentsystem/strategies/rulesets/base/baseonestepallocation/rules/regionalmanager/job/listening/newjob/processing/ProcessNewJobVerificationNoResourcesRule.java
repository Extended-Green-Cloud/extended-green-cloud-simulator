...
public class ProcessNewJobVerificationNoResourcesRule extends AgentBasicRule<RegionalManagerAgentProps, RMANode> {

	private static final Logger logger = getLogger(ProcessNewJobVerificationNoResourcesRule.class);

	public ProcessNewJobVerificationNoResourcesRule(
	...
	public AgentRule copy() {
		return new ProcessNewJobVerificationNoResourcesRule(controller);
	}
