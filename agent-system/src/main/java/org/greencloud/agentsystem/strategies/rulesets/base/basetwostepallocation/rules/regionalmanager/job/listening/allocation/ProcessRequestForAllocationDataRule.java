package org.greencloud.agentsystem.strategies.rulesets.base.basetwostepallocation.rules.regionalmanager.job.listening.allocation;
...
public class ProcessRequestForAllocationDataRule extends AgentBasicRule<RegionalManagerAgentProps, RMANode> {

	public ProcessRequestForAllocationDataRule(final RulesController<RegionalManagerAgentProps, RMANode> controller) {
		super(controller);
	}
	...
	public AgentRule copy() {
		return new ProcessRequestForAllocationDataRule(controller);
	}
