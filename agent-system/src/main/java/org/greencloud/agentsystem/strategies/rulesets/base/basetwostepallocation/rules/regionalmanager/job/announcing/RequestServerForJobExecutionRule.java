package org.greencloud.agentsystem.strategies.rulesets.base.basetwostepallocation.rules.regionalmanager.job.announcing;
...
public class RequestServerForJobExecutionRule extends AgentRequestRule<RegionalManagerAgentProps, RMANode> {
	...
	protected void handleInform(final ACLMessage inform, final RuleSetFacts facts) {
		...
		agentNode.reportJobAllocationAcceptance(1.0, agentProps.getAgentName());
