...
public class ComputeJobPriorityBasedOnExecutionTimeRule extends AgentBasicRule<CentralManagerAgentProps, CMANode> {

	private static final Logger logger = getLogger(ComputeJobPriorityBasedOnExecutionTimeRule.class);

	public ComputeJobPriorityBasedOnExecutionTimeRule(
	...
	public AgentRule copy() {
		return new ComputeJobPriorityBasedOnExecutionTimeRule(controller);
	}
