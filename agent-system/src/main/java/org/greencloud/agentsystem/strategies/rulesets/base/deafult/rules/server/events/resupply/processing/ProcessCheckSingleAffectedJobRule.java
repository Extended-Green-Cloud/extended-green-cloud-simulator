package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.server.events.resupply.processing;
...
public class ProcessCheckSingleAffectedJobRule extends AgentBasicRule<ServerAgentProps, ServerNode> {
	...
	public void executeRule(final RuleSetFacts facts) {
		...
		if (nonNull(greenSource)) {
			...
			final RuleSetFacts resupplyFacts = constructFactsWithJob(facts.get(RULE_SET_IDX), job);
	...
	public AgentRule copy() {
		return new ProcessCheckSingleAffectedJobRule(controller);
	}
