package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.regionalmanager.job.proposing;
...
public class ProposeToCMARule extends AgentProposalRule<RegionalManagerAgentProps, RMANode> {
	...
	protected ACLMessage createProposalMessage(final RuleSetFacts facts) {
		...
		final RuleSetFacts proposalFacts =
				constructFactsForDataAllocationPreparation(facts.get(RULE_SET_IDX), facts.get(MESSAGE), job, PROPOSE);
