package org.greencloud.agentsystem.strategies.deafult.rules.client.job.listening.processing;
...
import static org.greencloud.commons.enums.rules.EGCSDefaultRuleType.JOB_STATUS_RECEIVER_HANDLE_PROCESSING_RULE;
...
public class ProcessCMAProcessingJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAProcessingJobUpdateRule.class);

	public ProcessCMAProcessingJobUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
	...
	public AgentRule copy() {
		return new ProcessCMAProcessingJobUpdateRule(controller);
	}
