package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.server.job.listening.jobprice;
...
public class ListenForJobInstancePriceUpdateRule extends AgentMessageListenerRule<ServerAgentProps, ServerNode> {
	...
	public AgentRule copy() {
		return new ListenForJobInstancePriceUpdateRule(controller, getRuleSet());
	}
