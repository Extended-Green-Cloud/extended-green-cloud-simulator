package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.greenenergy.weather.processing;
...
public class ProcessNotEnoughEnergyForJobRule extends AgentBasicRule<GreenEnergyAgentProps, GreenEnergyNode> {
	...
	public AgentRule copy() {
		return new ProcessNotEnoughEnergyForJobRule(controller);
	}
