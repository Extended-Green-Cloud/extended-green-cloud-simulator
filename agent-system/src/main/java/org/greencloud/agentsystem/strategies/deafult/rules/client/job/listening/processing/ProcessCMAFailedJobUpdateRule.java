...
public class ProcessCMAFailedJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAFailedJobUpdateRule.class);

	public ProcessCMAFailedJobUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
	...
	public AgentRule copy() {
		return new ProcessCMAFailedJobUpdateRule(controller);
	}
