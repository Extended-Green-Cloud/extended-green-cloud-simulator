...
public class ProcessCMAJobExecutorUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAJobExecutorUpdateRule.class);

	public ProcessCMAJobExecutorUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
	...
	public AgentRule copy() {
		return new ProcessCMAJobExecutorUpdateRule(controller);
	}
