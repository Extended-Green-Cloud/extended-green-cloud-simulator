package org.greencloud.agentsystem.strategies.deault.rules.centralmanager.job.allocation.processing;
...
public class ProcessRegionalManagerAllocationRule extends AgentBasicRule<CentralManagerAgentProps, CMANode> {
	...
	public ProcessRegionalManagerAllocationRule(final RulesController<CentralManagerAgentProps, CMANode> controller) {
		super(controller);
	}
