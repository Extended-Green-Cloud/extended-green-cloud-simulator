package org.greencloud.agentsystem.strategies.rulesets.base.deafult.rules.centralmanager.job.listening.newjob.processing;
...
public class ProcessNewClientJobAlreadyExistsRule extends AgentBasicRule<CentralManagerAgentProps, CMANode> {

	private static final Logger logger = getLogger(ProcessNewClientJobAlreadyExistsRule.class);

	public ProcessNewClientJobAlreadyExistsRule(final RulesController<CentralManagerAgentProps, CMANode> controller) {
		super(controller, 3);
	}
	...
	public AgentRule copy() {
		return new ProcessNewClientJobAlreadyExistsRule(controller);
	}
