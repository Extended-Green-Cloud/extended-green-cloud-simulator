...
import static org.greencloud.commons.enums.rules.EGCSDefaultRuleType.JOB_STATUS_RECEIVER_HANDLE_ON_HOLD_JOB_RULE;
...
public class ProcessCMAJobOnHoldUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAJobOnHoldUpdateRule.class);

	public ProcessCMAJobOnHoldUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
	...
	public AgentRule copy() {
		return new ProcessCMAJobOnHoldUpdateRule(controller);
	}
