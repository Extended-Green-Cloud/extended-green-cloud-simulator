...
public class ProcessCMAJobOnBackUpUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessCMAJobOnBackUpUpdateRule.class);

	public ProcessCMAJobOnBackUpUpdateRule(final RulesController<ClientAgentProps, ClientNode> rulesController) {
	...
	public AgentRule copy() {
		return new ProcessCMAJobOnBackUpUpdateRule(controller);
	}
