...
public class JobHandlingInitiatorLog {
	...
	public static final String NEW_JOB_ESTIMATED_ENERGY_LOG = "Energy estimated for executing job {} is {}.";
	...
	public static final String NEW_JOB_LOOK_FOR_GS_NO_RESOURCES_AVAILABLE_LOG =
			"Not enough resources - sending refuse message to Cloud Network Agent";
	...
	public static final String SERVER_OFFER_ACCEPT_PROPOSAL_FAILURE_LOG =
			"Not enough resources to execute the job {}. Sending failure information and rejecting green source proposal";
