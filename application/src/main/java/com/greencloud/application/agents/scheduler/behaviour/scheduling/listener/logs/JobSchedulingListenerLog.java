package com.greencloud.application.agents.scheduler.behaviour.scheduling.listener.logs;
...
public class JobSchedulingListenerLog {
	...
	public static final String JOB_ENQUEUED_SUCCESSFULLY_LOG =
			"Job {} has been successfully added to job scheduling queue";
	public static final String QUEUE_THRESHOLD_EXCEEDED_LOG =
			"WARNING! The queue has reached the expected threshold!";
