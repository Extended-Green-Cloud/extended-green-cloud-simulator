package com.greencloud.application.agents.server.behaviour.errorhandling.initiator.logs;

/**
 * Class contains all constants used in logging information in initiator behaviours for power shortage
 */
public class ErrorHandlingInitiatorLog {
	...
	public static final String CNA_JOB_TRANSFER_PUT_ON_HOLD_SOURCE_LOG =
			"Transfer of job with id {} was unsuccessful! There is not enough resources to process job with backup power. "
					+ "Putting job on hold";
