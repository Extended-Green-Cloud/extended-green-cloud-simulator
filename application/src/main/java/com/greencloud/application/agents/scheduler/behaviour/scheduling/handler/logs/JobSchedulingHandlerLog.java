package com.greencloud.application.agents.scheduler.behaviour.scheduling.handler.logs;
...
public class JobSchedulingHandlerLog {
	...
	public static final String JOB_EXECUTION_AFTER_DEADLINE_LOG =
			"Sending FAIL information to Client. Job {} would be executed after deadline";
	public static final String JOB_ADJUST_TIME_LOG =
			"Job {} time frames are outdated. Adjusting job time frames to current time.";
