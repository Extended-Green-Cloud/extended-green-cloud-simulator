...
public class SchedulerManagementLog {
	...
	public static final String JOB_TIME_ADJUSTED_LOG =
			"Job {} has adjusted time frames. New job start: {}, new job edn: {}";
	public static final String INCREASE_DEADLINE_WEIGHT_LOG =
			"Deadline weight priority increased from {} to: {}";
	public static final String INCREASE_CPU_WEIGHT_LOG =
			"CPU weight priority increased from {} to: {}";
}
