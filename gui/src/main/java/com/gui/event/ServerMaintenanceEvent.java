...
import static com.gui.event.domain.EventTypeEnum.SERVER_MAINTENANCE_EVENT;
...
import com.gui.message.ServerMaintenanceMessage;
...
public class ServerMaintenanceEvent extends AbstractEvent {
	...
	protected ServerMaintenanceEvent(final Instant occurrenceTime, final String agentName,
		...
		super(SERVER_MAINTENANCE_EVENT, occurrenceTime, agentName);
