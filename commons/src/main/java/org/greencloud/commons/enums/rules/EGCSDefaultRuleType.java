 ...
 */
public class EGCSDefaultRuleType {

	/**
	 * RESOURCE RULES
	 */
	public static final String RMA_RESOURCE_REQUEST_RULE = "RMA_RESOURCE_REQUEST_RULE";
	public static final String RMA_RESOURCE_REQUEST_HANDLER_RULE = "RMA_RESOURCE_REQUEST_HANDLER_RULE";
	public static final String INITIALIZE_SERVER_RESOURCE_KNOWLEDGE = "INITIALIZE_SERVER_RESOURCE_KNOWLEDGE";
	public static final String SERVER_RESOURCE_INFORMATION_RULE = "SERVER_RESOURCE_INFORMATION_RULE";
	public static final String SERVER_RESOURCE_UPDATE_RULE = "SERVER_RESOURCE_UPDATE_RULE";
	public static final String JOB_EXECUTION_TIME_ESTIMATION_LISTENER = "JOB_EXECUTION_TIME_ESTIMATION_LISTENER";
	public static final String JOB_EXECUTION_TIME_ESTIMATION_HANDLER_RULE = "JOB_EXECUTION_TIME_ESTIMATION_HANDLER_RULE";
	public static final String ASK_FOR_FASTEST_EXECUTION_TIME = "ASK_FOR_FASTEST_EXECUTION_TIME";
	...
	public static final String LISTEN_FOR_JOB_TRANSFER_HANDLE_NO_AGENTS_RULE = "LISTEN_FOR_JOB_TRANSFER_HANDLE_NO_AGENTS_RULE";
	 ...
	 * SERVER ERROR RULES
	 */
	public static final String VALIDATE_SERVER_ERROR_RULE = "VALIDATE_SERVER_ERROR_RULE";
	public static final String VALIDATE_REGIONAL_ERROR_RULE = "VALIDATE_REGIONAL_ERROR_RULE";
	...
	public static final String NEW_JOB_ADD_JOB_RULE = "NEW_JOB_ADD_JOB_RULE";
	public static final String NEW_JOB_RECEIVER_HANDLER_RULE = "NEW_JOB_RECEIVER_HANDLER_RULE";
	public static final String NEW_JOB_VERIFICATION_RULE = "NEW_JOB_VERIFICATION_RULE";
	...
	public static final String NEW_JOB_RECEIVER_HANDLE_PROCESSING_LIMIT_RULE = "NEW_JOB_RECEIVER_HANDLE_PROCESSING_LIMIT_RULE";
	...
	public static final String NEW_JOB_POLLING_HANDLE_NO_RESOURCES_RULE = "NEW_JOB_POLLING_HANDLE_NO_RESOURCES_RULE";
	...
	public static final String PRE_EVALUATE_JOB_PRIORITY_RULE = "PRE_EVALUATE_JOB_PRIORITY_RULE";
	...
	public static final String NEW_JOB_VERIFY_DEADLINE_RULE = "NEW_JOB_VERIFY_DEADLINE_RULE";

	/**
	 * ALLOCATION RULES
	 */
	public static final String NEW_JOB_ALLOCATION_RULE = "NEW_JOB_ALLOCATION_RULE";
	public static final String NEW_JOB_ALLOCATION_REQUEST_DATA = "NEW_JOB_ALLOCATION_REQUEST_DATA";
	public static final String HANDLE_NEW_JOB_ALLOCATION_RULE = "HANDLE_NEW_JOB_ALLOCATION_RULE";
	public static final String PROCESS_NEW_JOB_UNSUCCESSFUL_ALLOCATION_RULE = "PROCESS_NEW_JOB_UNSUCCESSFUL_ALLOCATION_RULE";
	public static final String PROCESS_NEW_JOB_ALLOCATION_RULE = "PROCESS_NEW_JOB_ALLOCATION_RULE";
	public static final String ALLOCATION_DATA_REQUEST_RULE = "ALLOCATION_DATA_REQUEST_RULE";
	public static final String ALLOCATION_DATA_REQUEST_HANDLER_RULE = "ALLOCATION_DATA_REQUEST_HANDLER_RULE";
	public static final String PREPARE_DATA_FOR_JOB_ALLOCATION_RULE = "PREPARE_DATA_FOR_JOB_ALLOCATION_RULE";
	public static final String PREPARE_DATA_FOR_JOB_ALLOCATION_REQUEST_RULE = "PREPARE_DATA_FOR_JOB_ALLOCATION_REQUEST_RULE";
	public static final String PREPARE_JOB_PRICE_ESTIMATION_RULE = "PREPARE_JOB_PRICE_ESTIMATION_RULE";
	public static final String PREPARE_JOB_EXECUTION_ESTIMATION_RULE = "PREPARE_JOB_EXECUTION_ESTIMATION_RULE";
	public static final String PREPARE_SERVER_RESOURCES_RULE = "PREPARE_SERVER_RESOURCES_RULE";
	public static final String PARSE_SERVER_RESOURCES_RULE = "PARSE_SERVER_RESOURCES_RULE";
	...
	public static final String PROCESS_START_JOB_EXECUTION_RULE = "PROCESS_START_JOB_ON_GREEN_EXECUTION_RULE";
