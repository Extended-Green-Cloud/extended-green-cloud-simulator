package org.greencloud.strategyinjection.agentsystem.strategy.restaurant.service;
...
public class ListenForNewClientOrdersRule extends
	...
	public ListenForNewClientOrdersRule(
		...
		super(controller, strategy, ClientOrder.class, ORDER_TEMPLATE, 1, BASIC_LISTENER_HANDLER);
	}
